    ...
    <div class="container">
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="width: 20%;">Saldo Simpanan</th>
                ...
                <tbody>
                    ...
                    <tr class="stripe-row">
                        ...
                        <td class="text-right amount">{{ 'Rp. ' . number_format($transaksi->setoran, 0, ',', '.') }}</td>
                        <td>{{ $transaksi->tgl }}</td>
                    </tr>
                    @empty
                    @endforelse
        ...
        <div class="total-section">
            <div class="total-amount">
                Total Simpanan: <span class="amount">{{ 'Rp. ' . number_format($simpanan->saldo_simpanan, 0, ',', '.') }}</span>
            </div>
        </div>
        
        <div class="footer">
            <p><strong>Koperasi Karyawan JMB</strong></p>
            <p>Jl. Raya Cirebon Kuningan KM. 8, Ciperna, Talun, Ciperna, Kec. Talun, Kabupaten Cirebon, Jawa Barat 45171</p>
